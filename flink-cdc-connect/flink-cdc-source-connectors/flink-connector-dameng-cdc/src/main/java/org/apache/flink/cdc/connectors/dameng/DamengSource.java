...
public class DamengSource {
    ...
    /** Builder class of {@link DamengSource}. */
    public static class Builder<T> {

        private Integer port = 5236; // default 5236 port for Dameng
        ...
        /** The Debezium Dameng connector properties. For example, "snapshot.mode". */
        ...
        public DebeziumSourceFunction<T> build() {
            ...
            props.setProperty("connector.class", DamengConnector.class.getCanonicalName());
            ...
            return new DebeziumSourceFunction<>(
                    deserializer, props, null, new DamengValidator(props));
        }
    }
}
