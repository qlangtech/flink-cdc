...
package org.apache.flink.cdc.connectors.dameng;

import org.apache.flink.cdc.connectors.dameng.util.DamengJdbcUrlUtils;
...
public class DamengValidator implements Validator {

    private static final long serialVersionUID = 1L;

    private final Properties properties;

    private static final List<Integer> SUPPORT_VERSIONS = Arrays.asList(7, 8);
    ...
    public void validate() {
        try (Connection connection = openConnection(properties)) {
            ...
            throw new TableException(
                    "Unexpected error while connecting to Dameng and validating", ex);
        }
    }
    ...
    public static Connection openConnection(Properties properties) throws SQLException {
        try {
            ...
            throw new SQLException("Dameng JDBC Driver not found", e);
        }
        String url = DamengJdbcUrlUtils.getConnectionUrlWithSid(properties);
