...
/** Utilities for converting from dameng types to Flink types. */
public class DamengTypeUtils {
     ...
     * be true, copy from io.debezium.connector.dameng.DamengValueConverters#convert.
     */
        ...
        switch (column.jdbcType()) {
            ...
            default:
                throw new UnsupportedOperationException(
                        String.format(
                                "Don't support Dameng type '%s' yet, jdbcType:'%s'.",
