...
/** A Dameng datasource factory. */
public class DamengPooledDataSourceFactory extends JdbcConnectionPoolFactory {

    public static final String JDBC_URL_PATTERN = "jdbc:dm://%s:%s/%s";

    @Override
    public String getJdbcUrl(JdbcSourceConfig sourceConfig) {
        DamengSourceConfig damengSourceConfig = (DamengSourceConfig) sourceConfig;
        if (StringUtils.isNotBlank(damengSourceConfig.getUrl())) {
            return damengSourceConfig.getUrl();
        } else {
